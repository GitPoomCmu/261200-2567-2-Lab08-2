 ...
 */
  ...
  */
  ...
  class BenTheTurtle implements Runnable {
    public void run() {
        // Happy birthday Ben
        Turtle ben = new Turtle();
        ben.width(5);
        ben.speed(20);

        // Ben draws persimmon's leafs and stem.
        ben.penColor("lime"); // Set color.
        ben.up();
        // Positioning
        ben.left(180); 
        ben.forward(120);
        ...
        ben.setDirection(0);
        ben.forward(65);
        ben.dot("darkgreen", 40);
        ben.left(90);
        ben.forward(9);
        ben.dot("green", 25);
    }
  }
  class BrianTheTurtle implements Runnable {
    public void run() {
        // Happy birthday Brian
        Turtle brian = new Turtle();
        brian.width(5);
        brian.speed(20);

        // Brian draws an extra slice.
        brian.up();
        brian.setPosition(50, -150);
        brian.down();
        brian.left(60);
        brian.penColor("orange"); // Set color.
        brian.forward(220);
        // Half circle
        brian.right(80);
        for(int i=65; i>=0; i--){
 ...
 public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
 {
     ...
     public static void main(String[] a)
     {
        ...
        Thread ben = new Thread(new BenTheTurtle());
        Thread brian = new Thread(new BrianTheTurtle());
